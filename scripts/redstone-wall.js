    ...
    if (redstoneWall != null) {
        ...
        redstoneWall.buildType = prov(() => {
            return extend(Building, {
                ...
                // Hàm được Comduik gọi để tăng tốc độ phân rã
                applyComduikDrain() {
                    this.drainTicks = 2; // Giữ trạng thái rút điện trong 2 tick
                },

                updateTile() {
                    this.super$updateTile();

                    // Nếu đang bị Comduik rút điện, tốc độ tự hủy tăng 80% (1.8x)
